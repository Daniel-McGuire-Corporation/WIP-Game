...
$sourceFiles = @("leveledit.cpp", "nfd_win.cpp", "nfd_common.c")
$outputFile = "LevelEditor.exe"

# Compile the source files using MSVC
cl /I $includeDir $sourceFiles /Fe:$outputFile /link /LIBPATH:"..\..\3rdpty\lib" sfml-graphics.lib sfml-window.lib sfml-system.lib ole32.lib shell32.lib uuid.lib
