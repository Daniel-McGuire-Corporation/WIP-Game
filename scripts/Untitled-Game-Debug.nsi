...
;Settings
  ...
  !define APPNAME "Untitled Game (Alpha) Debug"
  !define APP_NAME_IN_INSTALLED_DIR "game-debug.exe"
  ...
  # Files Directory
  !define FILE_DIR "..\bin" #Replace with the full path of install folder
...
;General
  ...
  Name "${APPNAME}"
  Icon "${LOGO_ICON_FILE}"
  OutFile "UntitledGamedebugSetup.exe"

  ;Default installation folder
  InstallDir "@$APPDATA\Untitled-Gamedebug"
