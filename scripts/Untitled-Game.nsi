...
;Settings
  ...
  !define APPNAME "Untitled Game (Alpha)"
  !define APP_NAME_IN_INSTALLED_DIR "game.exe"
...
;General
  ...
  Name "${APPNAME}"
  Icon "${LOGO_ICON_FILE}"
  OutFile "UntitledGameSetup.exe"

  ;Default installation folder
  InstallDir "$APPDATA\Untitled-Game"
