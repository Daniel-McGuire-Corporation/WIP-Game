...
;Settings
  ...
  !define APPNAME "Untitled Game Tools"
  !define APP_NAME_IN_INSTALLED_DIR "leveleditor.exe"
  !define COMPANYNAME "Daniel McGuire Corporation"
  !define DESCRIPTION "Stickman Platform Game"
  !define DEVELOPER "Daniel McGuire" #License Holder
  # Files Directory
  !define FILE_DIR "..\tools\bin" #Replace with the full path of install folder
  ...
  !define VERSIONBUILD 8	#Maintenance release Number (bugfixes only)
  !define BUILDNUMBER 7		#Source control revision number
  # These will be displayed by the "Click here for support information" link in "Add/Remove Programs"
  # It is possible to use "mailto:" links in here to open email client
  !define HELPURL "https://github.com/Daniel-McGuire-Corporation/WIP-Game/issues"
  !define UPDATEURL "https://github.com/Daniel-McGuire-Corporation/WIP-Game/releases/latest"
  !define ABOUTURL "https://github.com/Daniel-McGuire-Corporation/WIP-Game/"
  # This is the size (in kB) of all the files copied into "Program Files"
  !define INSTALLSIZE 18260
...
;General
  ...
  Name "${APPNAME}"
  Icon "${LOGO_ICON_FILE}"
  OutFile "UntitledGame-ToolsSetup.exe"

  ;Default installation folder
  InstallDir "$APPDATA\Untitled-Gametools"
